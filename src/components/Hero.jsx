...
{/* leftside header text */}
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      <div className='flex flex-row items-center py-[12px] px-4 bg-discount-gradient
      rounded-[10px] mb-2'>
        <img src={discount} alt='discount' className='w-[26.66px] h-[26.66px]'/>
...
{/* Gradients of blue and pink behind the robot arm with cards with get started btn*/}
    <div className={`flex-1 flex md:my-0 my-10 relative ${styles.flexCenter}`}>
      <img src={robot} alt='billing'
       ...
       <div className='absolute z-[0] w-[35%] h-[40%] right-20 bottom-20 blue__gradient'/>
    </div>
    <div className={`ss:hidden ${styles.flexStart}`}><GetStarted/></div>
  </section>
  )
